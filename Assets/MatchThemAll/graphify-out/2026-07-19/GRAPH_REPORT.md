# Graph Report - Match Them All  (2026-07-13)

## Corpus Check
- 89 files · ~158,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1128 nodes · 1499 edges · 88 communities (71 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b1d5dc37`
...
4. `SaveManager` - 32 edges
5. `TutorialManager` - 26 edges
6. `LevelMapManager` - 23 edges
7. `Item` - 21 edges
...
Cohesion: 0.08
Nodes (20): Editor, DeletedItemRecord, DeletedItemRecordList, LevelEditorWindow, Match_Them_All.Scripts.Editor, RemovedLevelEntry, bool, Color (+12 more)

### Community 1 - "Item Manager Editor"
Cohesion: 0.07
Nodes (21): double, ItemManagerWindow, Match_Them_All.Scripts.Editor, EditorWindow, PreviewRenderUtility, bool, Color, EItemName (+13 more)
...
Cohesion: 0.05
Nodes (31): AudioClip, AudioMixerGroup, MatchThemAll.Scripts, SoundDataSO, int, ItemLevelData, List, Sprite (+23 more)
...
## Knowledge Gaps
- **407 isolated node(s):** `MatchThemAll.Scripts`, `MatchThemAll.Scripts`, `Dictionary`, `MatchThemAll.Scripts`, `ItemPlacer` (+402 more)
...
- **Why does `ItemPlacer` connect `Item Placement` to `Lose Panel`?**

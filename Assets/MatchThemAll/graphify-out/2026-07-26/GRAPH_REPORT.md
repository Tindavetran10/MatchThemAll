...
7. `ShopSetup` - 22 edges
8. `Item` - 21 edges
9. `TimerManager` - 20 edges
10. `InputManager` - 19 edges
...
Cohesion: 0.08
Nodes (21): Editor, DeletedItemRecord, DeletedItemRecordList, LevelEditorWindow, MatchThemAll.Scripts.Editor, RemovedLevelEntry, EditorWindow, bool (+13 more)
...
Cohesion: 0.13
Nodes (10): Action, Animator, GameObject, Image, PowerupDatabaseSO, PowerupDataSO, string, MatchThemAll.Scripts.Power_Ups (+2 more)
...
Cohesion: 0.11
Nodes (18): 10. Obsidian Second Brain, 11. Quick Commands, 1. Think Before Coding, 2. Simplicity First, 3. Surgical Changes, 4. Goal-Driven Execution, 5. graphify, 6. God Nodes (most connected — touch with extreme care) (+10 more)
...
Cohesion: 0.40
Nodes (3): PowerupContext, MatchThemAll.Scripts.Power_Ups, PowerupEffect
...
Cohesion: 0.13
Nodes (10): MatchThemAll.Scripts.Shop, ShopPanel, Button, GameObject, List, ShopDatabaseSO, ShopProductCard, string (+2 more)

### Community 90 - "Community 90"
Cohesion: 0.17
Nodes (9): HashSet, IIapService, MatchThemAll.Scripts.Shop, ShopManager, Action, IReadOnlyList, ShopDatabaseSO, ShopProductSO (+1 more)

### Community 91 - "Community 91"
Cohesion: 0.18
Nodes (8): MatchThemAll.Scripts.Shop, ShopProductCard, Button, GameObject, Image, ShopProductSO, TextMeshProUGUI, ShopPurchaseSucceededEvent

### Community 92 - "Community 92"
Cohesion: 0.20
Nodes (10): MatchThemAll.Scripts.Shop, ShopProductSO, ShopReward, bool, ECurrency, EKind, int, List (+2 more)
...
Cohesion: 0.20
Nodes (8): ECurrency, GameObject, int, PowerupEffect, Sprite, string, MatchThemAll.Scripts.Power_Ups, PowerupDataSO

### Community 95 - "Community 95"
Cohesion: 0.19
Nodes (8): EShopCategory, Obsolete, MatchThemAll.Scripts.Shop, ShopDatabaseSO, IEnumerable, List, ShopProductSO, ShopTabSO
...
Cohesion: 0.29
Nodes (5): List, PowerupDataSO, ScriptableObject, MatchThemAll.Scripts.Power_Ups, PowerupDatabaseSO
...
Cohesion: 0.33
Nodes (3): DebugGrantCurrencyButton, MatchThemAll.Scripts.Shop, int

### Community 103 - "Community 103"
Cohesion: 0.33
Nodes (5): MatchThemAll.Scripts.Shop, ShopTabSO, int, Sprite, string

### Community 104 - "Community 104"
Cohesion: 0.50
Nodes (3): EntitlementIds, MatchThemAll.Scripts.Shop, string
...
## Knowledge Gaps
- **467 isolated node(s):** `MatchThemAll.Scripts`, `MatchThemAll.Scripts`, `Dictionary`, `MatchThemAll.Scripts`, `ItemPlacer` (+462 more)
...
- **Why does `HintManager` connect `Hint System` to `Lose Panel`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `ItemSpotManager` connect `Item Spot Management` to `Lose Panel`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `LevelMapManager` connect `Community 85` to `Lose Panel`?**
